...
export default function AltitudeRangeFilterPopup({ min, max, altitudeRanges, setAltitudeRanges, onClose, onResetAltitudeRanges }) {
    ...
    // Adds a new altitude range segment
    ...
    // Updates a specific altitude range field
    ...
    // Removes an altitude range unless it's the only one
